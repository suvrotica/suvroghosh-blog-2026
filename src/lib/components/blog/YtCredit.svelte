<script>
    // No script logic needed, just static text
</script>

<div class="my-8 mx-auto max-w-2xl not-prose">
    <div class="flex flex-col items-center justify-center p-6 text-center rounded-xl border-2 border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900/50 shadow-[4px_4px_0px_0px_rgba(0,0,0,0.05)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.05)]">
